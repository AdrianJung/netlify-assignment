...
console.log(this.state)
    return (
      <div className="App">
          ...
          <GifBox url={this.state.correct_image} alt=""/>
          ...
          <GifBox url={this.state.incorrect_image_b} alt=""/>

          <p>C: {this.state.incorrect_answers[1]}</p>
          <GifBox url={this.state.incorrect_image_c} alt=""/>

          <p>D: {this.state.incorrect_answers[2]}</p>
          <GifBox url={this.state.incorrect_image_d} alt=""/>
          </GifBoxWrapper>
